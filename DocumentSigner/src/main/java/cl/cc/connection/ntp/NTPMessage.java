...
class NTPMessage {
    ...
    public static String timestampToString(double timestamp) {
        ...
        String date = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(timestampToDate(timestamp));
    ...
    /**
     * Returns a timestamp (number of seconds since 00:00 1-Jan-1900) as a date
     * object.
     *
     * @param timestamp
     * @return
